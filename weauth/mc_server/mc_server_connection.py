...
class MCServerConnection:
    ...
    def test_connection(self) -> (int, str):
        ...
        if server_type.upper() == "MCSM":
            return_code = MCSM.test_connection(
                mcsm_adr=self.params[0],
            ...
            return_code = RCON.test_connection(
                host_add=self.params[0], port=int(self.params[1]), passwd=self.params[2]
            )
            return return_code
    ...
    def push_command(self, command: str) -> (int, str):
        ...
        if server_type.upper() == "MCSM":
            ...
            return RCON.push_command(
                host_add=self.params[0],
