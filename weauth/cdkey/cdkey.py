...
class CDKey:
    ...
    def create_gift(gift_arg: str, gift_num: int, gift_total: int, gift_comment='无礼物注释') -> int:
        ...
        gift_str = gift_arg + gift_comment + str(gift_total) + str(gift_num)
        ...
        context = {gift_hash: {'gift_arg': gift_arg,  # 礼物 如 minecraft:command_block  可以带NBT标签
                               'gift_num': gift_num,  # 礼物个数   单次给予的礼物的数量
...
if __name__ == '__main__':
    ...
    CDKey.create_gift(gift_arg=text, gift_num=64, gift_total=15, gift_comment='草方块')
